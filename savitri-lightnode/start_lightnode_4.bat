@echo off
echo Starting Savitri Lightnode 4...

set DB_PATH=lightnode-4.db
set CONFIG_PATH=config/lightnode-4.toml
set NETWORK_KEY_PATH=lightnode-4-network.key
set PRODUCER_KEY_PATH=lightnode-4-producer.key
set TX_KEY_PATH=lightnode-4-tx.key
