...
mod tests {
    ...
    fn test_governance_params_default() {
        ...
        assert_eq!(params.quorum_threshold_bps, 1000);
        assert_eq!(params.approval_threshold_bps, 5000);
        assert_eq!(params.voting_period_blocks, 10080);
    }
    ...
    fn test_proposal_serialization() {
        ...
        let deserialized: Proposal = crate::safe_deserialize(&serialized).unwrap();
    ...
    fn test_vote_serialization() {
        ...
        let deserialized: Vote = crate::safe_deserialize(&serialized).unwrap();
